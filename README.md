...
[![version](https://img.shields.io/badge/version-v0.74.0-blue)](https://github.com/randomgitsrc/agateon)
...
| **Leaves no broken state** | Any hook that existed before is backed up at install time and **restored** on uninstall; otherwise you would be left with dangling symlinks to deleted scripts (**a dangling hook makes `git commit` fail outright**) |
