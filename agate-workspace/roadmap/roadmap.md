...
- **归属**：独立任务（TAG-MVWU-001，设计文档 §7 已备试点范围）；不依赖任何时长归因（该归因未定，见分析 §3.2）。
