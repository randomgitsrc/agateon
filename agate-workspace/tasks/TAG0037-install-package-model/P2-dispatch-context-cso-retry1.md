...
复审修订后的 `P2-design.md`，覆盖写 `P2-review-cso.md`（`status: approved | rejected`，`agent: cso`）。
...
- {AGATE_WORKSPACE}/tasks/TAG0037-install-package-model/P2-review-cso.md（首轮，待覆盖）
