...
|------|----------|------|------|--------|------|----------|----------|
| TAG0035 | gate 健壮性批（RM-AG0062 归并 + RM-AG0064 并入）：未知阶段 fail-open → exit 1 + 三处数字序号假设致非数字阶段名静默失效 + DEBT0037/0038，子批 ABCD 串行（DEBT0040/0041 已移出范围） | 🔄 | P4 | 中 | — | 2026-09-16 | 2026-09-16 |
