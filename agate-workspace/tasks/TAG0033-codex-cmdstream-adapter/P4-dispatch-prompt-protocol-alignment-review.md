...
你是 P4 阶段的 protocol-alignment-review 子 Agent。

## 你的角色定义
读取并严格遵循：
/home/kity/oclab/agateon/agate/assets/review-roles/protocol-alignment-review.md

## dispatch-context（核心输入）
读取并严格遵循：agate-workspace/tasks/TAG0033-codex-cmdstream-adapter/P4-dispatch-context-protocol-alignment-review.md
